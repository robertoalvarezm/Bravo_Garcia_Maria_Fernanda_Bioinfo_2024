...
\begin{verbatim}
##  [1] "angleAxis"      "balloonplot"    "bandplot"      
##  [4] "barplot2"       "bluered"        "boxplot2"      
##  [7] "ci2d"           "col2hex"        "colorpanel"    
## [10] "greenred"       "heatmap.2"      "hist2d"        
## [13] "lmplot2"        "lowess"         "ooplot"        
## [16] "overplot"       "panel.overplot" "plot.venn"     
## [19] "plotCI"         "plotLowess"     "plotmeans"     
## [22] "qqnorm.aov"     "redblue"        "redgreen"      
## [25] "reorder.factor" "residplot"      "rich.colors"   
## [28] "sinkplot"       "smartlegend"    "space"         
## [31] "textplot"       "venn"           "wapply"
\end{verbatim}
...
\begin{verbatim}
##  [1] ".rs.automation.resolveMode"        
##  [2] ".rs.markdown.resolveCompletionRoot"
##  [3] ".rs.resolveAliasedPath"            
##  [4] ".rs.resolveAliasedSymbol"          
##  [5] ".rs.resolveContextSourceRefs"      
##  [6] ".rs.resolveEnvironment"            
##  [7] ".rs.resolveFormals"                
##  [8] ".rs.resolveFormalsImpl"            
##  [9] ".rs.resolveFormalsImplS3Dispatch"  
## [10] ".rs.resolveObjectFromFunctionCall" 
## [11] ".rs.resolveObjectSource"           
## [12] ".rs.reticulate.resolveModule"      
## [13] ".rs.rnb.resolveActiveChunkId"      
## [14] "backsolve"                         
## [15] "forwardsolve"                      
## [16] "qr.solve"                          
## [17] "solve"                             
...
\begin{verbatim}
##  [1] -1.07999254 -0.15437396  1.19921813 -0.37576493
##  [5] -0.38833579  0.32574262 -0.15335014  1.30917310
##  [9] -0.09250348 -2.12556351
\end{verbatim}
...
\begin{verbatim}
##  [1]  1.579324182 -1.310889977 -1.667038869 -0.280449676
##  [5]  0.064384725 -0.304411597  1.580285712 -0.320097011
##  [9]  0.009956145  0.143941000
\end{verbatim}
...
\begin{verbatim}
##  [1]  1.29908119  0.64798464 -0.02069346  0.69540415
##  [5] -0.70017101  1.92071528  0.69451203  0.35853499
##  [9] -0.80357274  0.39755202
\end{verbatim}
...
\begin{verbatim}
##  [1] -12  -9  -6  -3   0   3   6   9  12  15  18  21  24  27
## [15]  30
\end{verbatim}
...
\begin{verbatim}
##  [1]  1  2  3  5  7 11  1  2  3  5  7 11  1  2  3  5  7 11  1
## [20]  2  3  5  7 11
\end{verbatim}
...
## 11 Levels: Abril August December February January ... September
\end{verbatim}
...
\ControlFlowTok{if}\NormalTok{(dinero}\SpecialCharTok{\textgreater{}=}\NormalTok{minimo }\SpecialCharTok{\&}\NormalTok{ vacaciones}\SpecialCharTok{==}\StringTok{"SI"}\NormalTok{)\{}
  \FunctionTok{print}\NormalTok{(}\StringTok{"Me voy a la playa, loser"}\NormalTok{)}
...
\chapter{Ciclos en R}\label{ciclos}

\section{\texorpdfstring{Ciclos \texttt{for} en R}{Ciclos for en R}}\label{ciclos-for-en-r}
...
Donde \texttt{variable} toma, en cada iteración, el valor de cada elemento en la secuencia. La secuencia puede ser un vector, lista o cualquier conjunto de elementos.

\subsection{Ejemplo básico}\label{ejemplo-buxe1sico}
...
\tightlist
\item
  \texttt{i} : es la variable que toma los valores del 1 al 5.
\item
  \texttt{print(i)} : imprime el valor de \texttt{i} en cada iteración.
\end{itemize}

\subsection{Ejemplo 2: Sumar los elementos de un vector}\label{ejemplo-2-sumar-los-elementos-de-un-vector}

Ahora, vamos a sumar los elementos de un vector usando un ciclo \texttt{for}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{9}\NormalTok{)}
...
\tightlist
\item
  Iniciamos la variable \texttt{suma} en 0.
\item
  En cada iteración, el valor de \texttt{i} se suma a \texttt{suma}, acumulando el resultado.
\end{itemize}

\subsection{Ejemplo 3: Multiplicar cada elemento de un vector por 2}\label{ejemplo-3-multiplicar-cada-elemento-de-un-vector-por-2}
...
\NormalTok{  vector[i] }\OtherTok{\textless{}{-}}\NormalTok{ vector[i] }\SpecialCharTok{*} \DecValTok{2}
\NormalTok{\}}
...
\tightlist
\item
  Usamos 1:length(\texttt{vector}) para iterar sobre los índices del vector.
\item
  En cada iteración, el valor correspondiente del vector se multiplica por 2.
\end{itemize}

\subsection{Ejemplo 4: Iterar sobre un dataframe}\label{ejemplo-4-iterar-sobre-un-dataframe}

Supongamos que tenemos un dataframe con datos biológicos y queremos iterar sobre cada fila para hacer cálculos.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Creamos un dataframe de ejemplo}
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{muestra =} \FunctionTok{c}\NormalTok{(}\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{, }\StringTok{"C"}\NormalTok{),}
                 \AttributeTok{conteo\_celular =} \FunctionTok{c}\NormalTok{(}\DecValTok{100}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{150}\NormalTok{),}
                 \AttributeTok{temperatura =} \FunctionTok{c}\NormalTok{(}\DecValTok{37}\NormalTok{, }\DecValTok{25}\NormalTok{, }\DecValTok{30}\NormalTok{))}

\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(df)) \{}
  \FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Muestra:"}\NormalTok{, df}\SpecialCharTok{$}\NormalTok{muestra[i], }
              \StringTok{"{-} Conteo celular:"}\NormalTok{, df}\SpecialCharTok{$}\NormalTok{conteo\_celular[i]))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Muestra: A {-} Conteo celular: 100"}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Muestra: B {-} Conteo celular: 200"}
\NormalTok{[}\DecValTok{1}\NormalTok{] }\StringTok{"Muestra: C {-} Conteo celular: 150"}
\end{Highlighting}
\end{Shaded}

\subsection{Ejercicios resueltos}\label{ejercicios-resueltos}

\subsubsection{Ejercicio 1: Sumar los cuadrados de los primeros 5 números}\label{ejercicio-1-sumar-los-cuadrados-de-los-primeros-5-nuxfameros}

Escribe un ciclo for que sume los cuadrados de los números del 1 al 5.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{suma\_cuadrados }\OtherTok{\textless{}{-}} \DecValTok{0}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\DecValTok{5}\NormalTok{) \{}
\NormalTok{  suma\_cuadrados }\OtherTok{\textless{}{-}}\NormalTok{ suma\_cuadrados }\SpecialCharTok{+}\NormalTok{ i}\SpecialCharTok{\^{}}\DecValTok{2}
\NormalTok{\}}
\FunctionTok{print}\NormalTok{(suma\_cuadrados)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Ejercicio 2: Imprimir solo los números pares de un vector}\label{ejercicio-2-imprimir-solo-los-nuxfameros-pares-de-un-vector}

Dado el siguiente vector, escribe un ciclo for que imprima solo los números pares.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vector }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{4}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{7}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{12}\NormalTok{)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in}\NormalTok{ vector) \{}
...
\tightlist
\item
  Ejercicio 2: Encontrar el valor máximo en un vector
\end{enumerate}
...
\tightlist
\item
  Ejercicio 3: Contar los números mayores a 50
\end{enumerate}
...
\tightlist
\item
  Ejercicio 4: Imprimir los nombres de las muestras con conteo celular mayor a 150
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{muestra =} \FunctionTok{c}\NormalTok{(}\StringTok{"A"}\NormalTok{, }\StringTok{"B"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"D"}\NormalTok{),}
                 \AttributeTok{conteo\_celular =} \FunctionTok{c}\NormalTok{(}\DecValTok{100}\NormalTok{, }\DecValTok{200}\NormalTok{, }\DecValTok{150}\NormalTok{, }\DecValTok{180}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Ejercicio 5: Calcular la media de cada fila en un dataframe
\end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{ensayo1 =} \FunctionTok{c}\NormalTok{(}\FloatTok{2.5}\NormalTok{, }\FloatTok{3.1}\NormalTok{, }\FloatTok{4.7}\NormalTok{),}
                 \AttributeTok{ensayo2 =} \FunctionTok{c}\NormalTok{(}\FloatTok{3.5}\NormalTok{, }\FloatTok{2.9}\NormalTok{, }\FloatTok{4.2}\NormalTok{),}
                 \AttributeTok{ensayo3 =} \FunctionTok{c}\NormalTok{(}\FloatTok{4.1}\NormalTok{, }\FloatTok{3.8}\NormalTok{, }\FloatTok{4.5}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

Escribe un ciclo for que calcule la media de los valores de cada fila.

\section{\texorpdfstring{Ciclos \texttt{while} en R}{Ciclos while en R}}\label{ciclos-while-en-r}

El bucle \texttt{while} se utiliza en situaciones donde no sabemos de antemano cuántas veces se repetirá una operación, a diferencia del bucle \texttt{for}, que itera un número conocido de veces.

\subsection{Sintaxis}\label{sintaxis-1}

\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{while}\NormalTok{ (condición) \{}
  \CommentTok{\# Bloque de código}
  \CommentTok{\# Ejecuta }\AlertTok{TODO}\CommentTok{ lo que está dientro }
  \CommentTok{\# MIENTRAS la condicón sea VERDADERA}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  \textbf{condición}: Es una expresión lógica que debe evaluarse como verdadera (TRUE) para que el bucle continúe ejecutándose.
\item
  \textbf{bloque de código}: Es el conjunto de instrucciones que se ejecutan en cada iteración del bucle.
\end{itemize}

\textbf{Ejemplo básico}

Vamos a ver un ejemplo básico para entender cómo funciona el bucle \texttt{while} en R. En este caso, el bucle continuará ejecutándose hasta que el valor de x sea mayor que 5.
...
\subsubsection{Ejemplo 1: Suma de números enteros}\label{ejemplo-1-suma-de-nuxfameros-enteros}
...
\ControlFlowTok{while}\NormalTok{ (suma }\SpecialCharTok{\textless{}=} \DecValTok{1000}\NormalTok{) \{}
\NormalTok{  suma }\OtherTok{\textless{}{-}}\NormalTok{ suma }\SpecialCharTok{+}\NormalTok{ contador}
\NormalTok{  contador }\OtherTok{\textless{}{-}}\NormalTok{ contador }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"Número de iteraciones:"}\NormalTok{, contador }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"Suma total:"}\NormalTok{, suma, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Ejemplo 2: Secuencia de Fibonacci}\label{ejemplo-2-secuencia-de-fibonacci}
...
\FunctionTok{cat}\NormalTok{(}\StringTok{"Secuencia de Fibonacci:}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ControlFlowTok{while}\NormalTok{ (contador }\SpecialCharTok{\textless{}} \DecValTok{10}\NormalTok{) \{}
  \FunctionTok{cat}\NormalTok{(a, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\NormalTok{  temp }\OtherTok{\textless{}{-}}\NormalTok{ a }\SpecialCharTok{+}\NormalTok{ b}
\NormalTok{  a }\OtherTok{\textless{}{-}}\NormalTok{ b}
\NormalTok{  b }\OtherTok{\textless{}{-}}\NormalTok{ temp}
\NormalTok{  contador }\OtherTok{\textless{}{-}}\NormalTok{ contador }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Ejemplo 3: Factorial de un número}\label{ejemplo-3-factorial-de-un-nuxfamero}

Escribe un programa que calcule el factorial de un número entero dado. El factorial de un número \textbf{n}
es el producto de todos los números enteros positivos menores o iguales a n
...
\ControlFlowTok{while}\NormalTok{ (contador }\SpecialCharTok{\textless{}=}\NormalTok{ n) \{}
\NormalTok{  factorial }\OtherTok{\textless{}{-}}\NormalTok{ factorial }\SpecialCharTok{*}\NormalTok{ contador}
\NormalTok{  contador }\OtherTok{\textless{}{-}}\NormalTok{ contador }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"Factorial de"}\NormalTok{, n, }\StringTok{"es:"}\NormalTok{, factorial, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{\texorpdfstring{Ejemplo 4: Aproximación de \(\pi\) mediante series}{Ejemplo 4: Aproximación de \textbackslash pi mediante series}}\label{ejemplo-4-aproximaciuxf3n-de-pi-mediante-series}

Utiliza la serie de Leibniz para calcular una aproximación de \(\pi\). La serie de Leibniz es:
\[\pi=4( 1- \frac{1}{3} +\frac{1}{5} -\frac{1}{7} +\frac{1}{9} + \ldots )\]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{pi\_aprox }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{tolerancia }\OtherTok{\textless{}{-}} \FloatTok{1e{-}6}
\NormalTok{diferencia }\OtherTok{\textless{}{-}} \DecValTok{1}
\NormalTok{contador }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{signo }\OtherTok{\textless{}{-}} \DecValTok{1}

\ControlFlowTok{while}\NormalTok{ (diferencia }\SpecialCharTok{\textgreater{}}\NormalTok{ tolerancia) \{}
\NormalTok{  nueva\_aprox }\OtherTok{\textless{}{-}}\NormalTok{ pi\_aprox }\SpecialCharTok{+}\NormalTok{ signo }\SpecialCharTok{*}\NormalTok{ (}\DecValTok{4} \SpecialCharTok{/}\NormalTok{ (}\DecValTok{2} \SpecialCharTok{*}\NormalTok{ contador }\SpecialCharTok{+} \DecValTok{1}\NormalTok{))}
\NormalTok{  diferencia }\OtherTok{\textless{}{-}} \FunctionTok{abs}\NormalTok{(nueva\_aprox }\SpecialCharTok{{-}}\NormalTok{ pi\_aprox)}
\NormalTok{  pi\_aprox }\OtherTok{\textless{}{-}}\NormalTok{ nueva\_aprox}
\NormalTok{  signo }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\NormalTok{signo}
\NormalTok{  contador }\OtherTok{\textless{}{-}}\NormalTok{ contador }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"Aproximación de pi:"}\NormalTok{, pi\_aprox, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cat}\NormalTok{(}\StringTok{"Número de iteraciones:"}\NormalTok{, contador, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Ejemplo 5: Encontrar la raíz cuadrada de un número usando el método de bisección}\label{ejemplo-5-encontrar-la-rauxedz-cuadrada-de-un-nuxfamero-usando-el-muxe9todo-de-bisecciuxf3n}
...
\NormalTok{low }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{high }\OtherTok{\textless{}{-}}\NormalTok{ x}
\NormalTok{guess }\OtherTok{\textless{}{-}}\NormalTok{ (low }\SpecialCharTok{+}\NormalTok{ high) }\SpecialCharTok{/} \DecValTok{2}

\ControlFlowTok{while}\NormalTok{ (}\FunctionTok{abs}\NormalTok{(guess}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{{-}}\NormalTok{ x) }\SpecialCharTok{\textgreater{}}\NormalTok{ tol) \{}
  \ControlFlowTok{if}\NormalTok{ (guess}\SpecialCharTok{\^{}}\DecValTok{2} \SpecialCharTok{\textless{}}\NormalTok{ x) \{}
\NormalTok{    low }\OtherTok{\textless{}{-}}\NormalTok{ guess}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{    high }\OtherTok{\textless{}{-}}\NormalTok{ guess}
\NormalTok{  \}}
\NormalTok{  guess }\OtherTok{\textless{}{-}}\NormalTok{ (low }\SpecialCharTok{+}\NormalTok{ high) }\SpecialCharTok{/} \DecValTok{2}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"La raíz cuadrada aproximada de"}\NormalTok{, x, }\StringTok{"es:"}\NormalTok{, guess, }\StringTok{"}\SpecialCharTok{\textbackslash{}n}\StringTok{"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Ejercicio 1: Crecimiento bacteriano simple}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bacterias }\OtherTok{\textless{}{-}} \DecValTok{100}
\NormalTok{horas }\OtherTok{\textless{}{-}} \DecValTok{0}

\ControlFlowTok{while}\NormalTok{ (bacterias }\SpecialCharTok{\textless{}=} \DecValTok{10000}\NormalTok{) \{}
\NormalTok{  bacterias }\OtherTok{\textless{}{-}}\NormalTok{ bacterias }\SpecialCharTok{*} \DecValTok{2}
\NormalTok{  horas }\OtherTok{\textless{}{-}}\NormalTok{ horas }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"Número de horas:"}\NormalTok{, horas)}
\end{Highlighting}
\end{Shaded}
...
\textbf{Ejercicio 2: Tasa de mortalidad bacteriana}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{bacterias }\OtherTok{\textless{}{-}} \DecValTok{500}
\NormalTok{horas }\OtherTok{\textless{}{-}} \DecValTok{0}

\ControlFlowTok{while}\NormalTok{ (bacterias }\SpecialCharTok{\textgreater{}=} \DecValTok{50}\NormalTok{) \{}
\NormalTok{  bacterias }\OtherTok{\textless{}{-}}\NormalTok{ bacterias }\SpecialCharTok{*} \FloatTok{0.8}  \CommentTok{\# reducción del 20\%}
\NormalTok{  horas }\OtherTok{\textless{}{-}}\NormalTok{ horas }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}
...
\textbf{Ejercicio 3: Ciclos de infección viral}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{particulas }\OtherTok{\textless{}{-}} \DecValTok{1000}
\NormalTok{ciclos }\OtherTok{\textless{}{-}} \DecValTok{0}

\ControlFlowTok{while}\NormalTok{ (particulas }\SpecialCharTok{\textless{}} \DecValTok{1000000}\NormalTok{) \{}
\NormalTok{  particulas }\OtherTok{\textless{}{-}}\NormalTok{ particulas }\SpecialCharTok{*} \DecValTok{50}
\NormalTok{  ciclos }\OtherTok{\textless{}{-}}\NormalTok{ ciclos }\SpecialCharTok{+} \DecValTok{1}
\NormalTok{\}}

\FunctionTok{cat}\NormalTok{(}\StringTok{"Número de ciclos de infección:"}\NormalTok{, ciclos)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Ejercicios sugeridos}\label{ejercicios-sugeridos}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  \textbf{Ejercicio 1: Producción de antibióticos}
\end{enumerate}
...
\tightlist
\item
  \textbf{Ejercicio 2: Decaimiento de una toxina}
\end{enumerate}
...
\subsubsection{Ejercicios propuestos}\label{ejercicios-propuestos-1}
