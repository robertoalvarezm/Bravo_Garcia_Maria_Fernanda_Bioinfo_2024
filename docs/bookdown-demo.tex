...
\begin{verbatim}
##  [1]  0.09070048  0.26851615 -0.44390266  0.07077542  1.02491182 -0.04978241
##  [7] -0.05316822 -1.07312133 -0.37984925 -0.21070461
\end{verbatim}
...
\begin{verbatim}
##  [1] -0.05914702  0.50620337  0.98183711 -0.26056275 -0.66088867  1.18387732
##  [7]  0.33818016  0.92674297 -1.39653160 -0.59745400
\end{verbatim}
...
\begin{verbatim}
##  [1] -0.9861281  0.2280080  0.9362491 -0.1560571 -1.4999624 -0.9342705
##  [7]  1.3070124 -0.2578319 -0.8201453  0.8138734
\end{verbatim}
...
\chapter{Ciclos en R}\label{ciclos-en-r}

\section{\texorpdfstring{Introducción a los ciclos \texttt{for} en R}{Introducción a los ciclos for en R}}\label{introducciuxf3n-a-los-ciclos-for-en-r}
...
r
Copiar código
vector \textless- c(1, 2, 3, 4, 5)
for (i in 1:length(vector)) \{
vector{[}i{]} \textless- vector{[}i{]} * 2
\}
print(vector)
Resultado:
...
df \textless- data.frame(muestra = c(``A'', ``B'', ``C''),
conteo\_celular = c(100, 200, 150),
temperatura = c(37, 25, 30))

for (i in 1:nrow(df)) \{
print(paste(``Muestra:'', df\(muestra[i],
              "- Conteo celular:", df\)conteo\_celular{[}i{]}))
\}
Resultado:
...
r
Copiar código
suma\_cuadrados \textless- 0
for (i in 1:5) \{
suma\_cuadrados \textless- suma\_cuadrados + i\^{}2
\}
print(suma\_cuadrados)
Resultado:
...
r
Copiar código
vector \textless- c(1, 4, 5, 6, 7, 10, 12)
for (i in vector) \{
if (i \%\% 2 == 0) \{
print(i)
\}
...
r
Copiar código
df \textless- data.frame(muestra = c(``A'', ``B'', ``C'', ``D''),
conteo\_celular = c(100, 200, 150, 180))
...
r
Copiar código
df \textless- data.frame(ensayo1 = c(2.5, 3.1, 4.7),
...
Este tutorial incluye una introducción clara a los ciclos \texttt{for} en R, ejemplos detallados, ejercicios resueltos y ejercicios propuestos que permiten a los estudiantes practicar y aplicar los conceptos aprendidos.
